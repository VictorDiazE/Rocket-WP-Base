  ...
  <div id="page" class="site margin-top-content">
    <header id="masthead" class="site-header fixed-top">
      <nav class="navbar-main navbar-expand-lg
        ...
        <div class="top-bar wrapper bg-light-grey py-2">
          <div class="container-fluid">
            <div class="row">
              <div class="col-12">
                <div class="d-flex align-items-center justify-content-end">
                  <div class="mr-3">
                    <?php $social_group = get_field('social_group', 'option'); ?>
                    <?php while (have_rows('social_group', 'option')) : the_row(); ?>
                      <?php $social_label = get_sub_field('social_group_label', 'option'); ?>
                      <?php $social_label = strtolower($social_label); ?>
                      <a href="
                          <?php the_sub_field('social_group_link', 'option') ?>" target="_blank">
                        <span class="icon-<?php echo $social_label ?> color-black ml-3"></span>
                      </a>
                    <?php endwhile; ?>
                  </div>
                </div>
